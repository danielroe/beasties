...
- `preserveStylesheetOrder` **[Boolean](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Boolean)** Process external stylesheets sequentially to preserve their order. By default, external stylesheets are processed in parallel for performance. Enable this option if stylesheet order matters for your CSS specificity. _(default: `false`)_
